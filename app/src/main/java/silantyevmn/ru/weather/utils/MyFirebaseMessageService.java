...
import silantyevmn.ru.weather.activity.MainActivity;
...
public class MyFirebaseMessageService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        // Если здесь не создавать уведомления, при активном приложении они не будут создаваться
    ...
    private void makeNote(Context context, String title, String message) {
        ...
        // но и заполнились бы данные в activity
